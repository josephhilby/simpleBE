...
const file_v1_hello_proto_rawDesc = "" +
	"\n" +
	"\x0ev1/hello.proto\x12\x02pb\"\x0e\n" +
	"\fHelloRequest\"&\n" +
	"\n" +
	"HelloReply\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2<\n" +
	"\fHelloService\x12,\n" +
	"\bGetHello\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReplyB\x17Z\x15simpleBE/api/pb/v1;v1b\x06proto3"
...
var file_v1_hello_proto_depIdxs = []int32{
	0, // 0: pb.HelloService.GetHello:input_type -> pb.HelloRequest
	1, // 1: pb.HelloService.GetHello:output_type -> pb.HelloReply
