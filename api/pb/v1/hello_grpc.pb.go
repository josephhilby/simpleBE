...
//  api/proto/v1/hello.proto/v1/hello.proto
...
const (
	HelloService_GetHello_FullMethodName = "/pb.HelloService/GetHello"
)
...
func (c *helloServiceClient) GetHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
...
func (UnimplementedHelloServiceServer) GetHello(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _HelloService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).GetHello(ctx, req.(*HelloRequest))
	}
